...
parser.add_argument('--data', default='.', metavar='N',
...
def main():
    ...
    args.data = '/home/yinxiaojie/datasets/ILSVRC2012/images'
    args.lr = 0.02
    args.batch_size = 256
...
def main_worker(gpu, ngpus_per_node, args):
    ...
    model = ClassifierClass(num_classes=1000, latent_size=args.latent_size, scale=224 // 8)
